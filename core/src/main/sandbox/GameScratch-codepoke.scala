...
class LaserBeam2 {
  val tx_center = new Texture(Gdx.files.internal("narrow-mid.png"))
  val tx_start = new Texture(Gdx.files.internal("narrow-start.png"))
  val tx_end = new Texture(Gdx.files.internal("narrow-end.png"))
